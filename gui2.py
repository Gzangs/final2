...
class GradeApp:
    ...
    def save_results(self, student_name, scores, average_grade, lowest_score, highest_score) -> None:
        """
        ...
        with open('grades.csv', 'a', newline='') as file:
            ...
            writer.writerow([f"Name: {student_name}", f"{scores}", f"Grade: {highest_score}", f"Lowest score: {lowest_score}", f"Average score: {average_grade}"])
